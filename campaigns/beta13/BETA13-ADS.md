...
| Asset | Variant | Angle |
|-------|---------|--------|
| `campaigns/beta13/creatives/neural-junkie-security-local-ad-1080.png` | `security` | Local-first hub hardening |
| `campaigns/beta13/creatives/neural-junkie-cli-agents-ad-1080.png` | `cli-agents` | 12 CLI tools auto-detected |
| `campaigns/beta13/creatives/neural-junkie-tiff-previewer-ad-1080.png` | `tiff-previewer` | In-app TIFF previewer for plate wells |
| `campaigns/beta13/creatives/neural-junkie-slack-ad-1080.png` | `slack` | Any NJ agent → Slack bot (dev / power user) |
| `campaigns/beta13/creatives/neural-junkie-slack-ad-nondev-1080.png` | `slack-nondev` | Team Slack channel + AI helper (non-dev) |
| `campaigns/beta13/creatives/neural-junkie-slack-ad-models-1080.png` | `slack-models` | Pick Claude / GPT / Ollama / etc. per channel |

Prior release ads remain valid: [BETA12-ADS.md](../beta12/BETA12-ADS.md), [NONDEV-ADS.md](../nondev/NONDEV-ADS.md).
