...
**Cover image:** `campaigns/lora/creatives/neural-junkie-lora-ad-1200.png` (1200×627)

**Two-tier story (inference vs LoRA):** [TWO-TIER-LORA-LINKEDIN.md](../two-tier-lora/TWO-TIER-LORA-LINKEDIN.md) — cover `campaigns/two-tier-lora/creatives/neural-junkie-two-tier-lora-1200.png`

**LoRA v2 upgrade:** [LORA-V2-LINKEDIN.md](../lora-v2/LORA-V2-LINKEDIN.md) — cover `campaigns/lora-v2/creatives/neural-junkie-lora-v2-1200.png`
...
**Security on a LoRA base.** Install the Specialist tuning bootstrap LoRA — assign nj-security:14b to SecurityReviewer (composed on llama3.2:3b). See [TWO-TIER-LORA-LINKEDIN.md](../two-tier-lora/TWO-TIER-LORA-LINKEDIN.md) for why inference and LoRA use different bases.
