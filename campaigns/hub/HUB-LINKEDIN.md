...
**Cover image:** `campaigns/hub/creatives/neural-junkie-hub-1200.png` (1200×627)
...
**Related articles:** [Model layering](../model-layering/MODEL-LAYERING-LINKEDIN.md) · [Inference layer](../inference-layer/INFERENCE-LAYER-LINKEDIN.md) · [Loop stack](../loop-stack/LOOP-STACK-LINKEDIN.md) · [Collaboration](../collaboration/COLLABORATION-LINKEDIN.md)
...
**Key insight:** the desktop doesn't pick the model for collab tasks, delegation consults, or tool loops. The **hub's inference layer** does — and attaches a routing trace on the message so you can audit it. See [Inference layer](../inference-layer/INFERENCE-LAYER-LINKEDIN.md) and [Model layering](../model-layering/MODEL-LAYERING-LINKEDIN.md) for the per-turn detail.
...
This is the difference between a demo and a product. See [Collaboration](../collaboration/COLLABORATION-LINKEDIN.md) and [Loop stack](../loop-stack/LOOP-STACK-LINKEDIN.md) for the full loop map.
...
|---------|----------------------|
| [Model layering](../model-layering/MODEL-LAYERING-LINKEDIN.md) | Context, weights, routing, orchestration per turn |
| [Inference layer](../inference-layer/INFERENCE-LAYER-LINKEDIN.md) | Decide before you generate — closure skips inference |
| [Modular AI composition](../modular-ai/MODULAR-AI-COMPOSITION-LINKEDIN.md) | Pack-declared compose stacks; routing badges |
| [Loop stack](../loop-stack/LOOP-STACK-LINKEDIN.md) | Collab, implementation, fix, tool, and guard loops |
| [Collaboration](../collaboration/COLLABORATION-LINKEDIN.md) | Phases, DAG, workspace gates |
| [Conversation memory](../conversation-memory/CONVERSATION-MEMORY-LINKEDIN.md) | Hub-indexed retrieval, not transcript stuffing |
| [LoRA / MCP](../lora/LORA-LINKEDIN.md) | Weight and knowledge layers agents call through the hub |
...
**Next in the series:** [Model layering](../model-layering/MODEL-LAYERING-LINKEDIN.md) — how the hub picks models at four levels once a turn deserves inference.
