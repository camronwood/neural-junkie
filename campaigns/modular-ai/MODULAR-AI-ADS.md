...
| Asset | Variant | Angle |
|-------|---------|-------|
| `campaigns/modular-ai/creatives/neural-junkie-modular-router-ad-1080.png` | `router` | Small 9B classifier routes domain + cost |
| `campaigns/modular-ai/creatives/neural-junkie-routing-badge-ad-1080.png` | `observe` | See which model ran on every reply |
| `campaigns/modular-ai/creatives/neural-junkie-compose-specialist-ad-1080.png` | `compose` | Packs declare chat + tool + LoRA |
| `campaigns/modular-ai/creatives/neural-junkie-hardware-stacks-ad-1080.png` | `stacks` | Recommended inference + LoRA per RAM tier |
| `campaigns/modular-ai/creatives/neural-junkie-modular-ai-composition-1200.png` | article | LinkedIn article cover |

Related: [MODULAR-AI-COMPOSITION-LINKEDIN.md](MODULAR-AI-COMPOSITION-LINKEDIN.md) · [MODEL-LAYERING-LINKEDIN.md](../model-layering/MODEL-LAYERING-LINKEDIN.md)
...
Use [MODULAR-AI-COMPOSITION-LINKEDIN.md](MODULAR-AI-COMPOSITION-LINKEDIN.md) as the long-form LinkedIn article. Cover: `campaigns/modular-ai/creatives/neural-junkie-modular-ai-composition-1200.png`.
