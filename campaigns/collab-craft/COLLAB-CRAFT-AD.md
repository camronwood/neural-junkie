...
**Asset:** `campaigns/collab-craft/creatives/neural-junkie-collab-craft-ad-1080.png`

Related: [COLLABORATION.md](../../docs/COLLABORATION.md) · [COMMUNITY-AD.md](../community/COMMUNITY-AD.md) (feedback invite) · existing orchestration ad (`compose-collaboration-ad.sh`).
...
After a release that touches collaboration. Follow with [COMMUNITY-AD.md](../community/COMMUNITY-AD.md) if you want "try it and file issues" in the same week.
