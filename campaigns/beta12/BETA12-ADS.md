...
```bash
chmod +x ./scripts/compose-beta12-ads.sh
./scripts/compose-beta12-ads.sh all
```

| Asset | Variant | Angle |
|-------|---------|--------|
| `campaigns/beta12/creatives/neural-junkie-domain-packs-ad-1080.png` | `packs` | Dev pack vs Life sciences pack — one toggle |
| `campaigns/beta12/creatives/neural-junkie-session-memory-ad-1080.png` | `session-memory` | Turn intent + rolling session summary |
| `campaigns/beta12/creatives/neural-junkie-runbook-actions-ad-1080.png` | `runbook-actions` | HTTP/webhook steps in runbook DAG |
| `campaigns/beta12/creatives/neural-junkie-biology-pack-ad-1080.png` | `biology` | Sequence analysis + ESMFold |

Non-developer ads from beta.11 remain valid: [NONDEV-ADS.md](../nondev/NONDEV-ADS.md), [SECOND-OPINION-AD.md](../nondev/SECOND-OPINION-AD.md).

---

## Ad 1 — Domain packs

**Headline on image:** Dev team or lab team. One toggle.
...
**Headline on image:** DMs that remember without re-pasting

**X / LinkedIn:**

> Stop re-explaining your project every DM message.
>
...
## Ad 3 — Runbook actions

**Headline on image:** HTTP in the DAG. No LLM turn.

**X / LinkedIn:**

> Runbooks aren’t only agent steps anymore.
>
...
**Headline on image:** Sequences in. Structures out.
