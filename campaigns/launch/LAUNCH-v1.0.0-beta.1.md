...
**Image (beta.6):** `campaigns/product/creatives/neural-junkie-context-scope-ad-1080.png`

**Image (general download):** `campaigns/launch/creatives/neural-junkie-beta-download-ad-1080.png`
...
**Ads:** `campaigns/beta12/BETA12-ADS.md` · `./scripts/compose-beta12-ads.sh all`
...
**Image:** `campaigns/collaboration/creatives/neural-junkie-collaboration-ad-1080.png` (regenerate: `./scripts/compose-collaboration-ad.sh`)
...
5. Follow-up in 3–5 days: `campaigns/product/creatives/neural-junkie-local-ai-tokens-ad-1080.png`
