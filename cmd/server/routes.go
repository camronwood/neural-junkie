...
func registerRoutes() {
	...
	http.HandleFunc("/api/music", corsMiddleware(localOnly(handleMusicRoute)))
	http.HandleFunc("/api/cad/render", corsMiddleware(localOnly(handleCADRender)))
	http.HandleFunc("/api/cad/mesh", corsMiddleware(localOnly(handleCADMesh)))
	http.HandleFunc("/api/cad/params", corsMiddleware(localOnly(handleCADParams)))
	http.HandleFunc("/api/cad/versions", corsMiddleware(localOnly(handleCADVersions)))
	http.HandleFunc("/api/cad/versions/restore", corsMiddleware(localOnly(handleCADVersionRestore)))
	http.HandleFunc("/api/cad/test-openscad", corsMiddleware(localOnly(handleCADTestOpenSCAD)))
