...
- When open_artifact_id / open_artifact_renderer is set in features, prefer artifact for turns that change that open canvas (add/fill text, mermaid, or images on that page); include prior_reference. Pure questions about what is on the page stay answer with reason_codes including canvas_meta_question (or canvas_title_question for why-named / title asks). Renaming/retitling the open canvas is artifact — never canvas_meta_question or answer-only.
