#!/usr/bin/env python3
"""Model Arena pack hub sidecar entrypoint."""
...
class PackHubHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path.startswith("/api/arena"):
            ...
            arena.handle_get(self, path, self.settings, self.pack_dir)
            return
    ...
    def do_POST(self) -> None:
        ...
        if path.startswith("/api/arena"):
            ...
            arena.handle_post(self, path, body, self.settings, self.pack_dir)
            return
        self._json(404, {"error": "not found"})
