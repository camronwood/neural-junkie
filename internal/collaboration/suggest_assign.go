...
var typeKeywords = map[protocol.AgentType][]string{
	...
	protocol.AgentTypeGenomics:          {"biology", "genomics", "protein", "gene", "genome", "dna", "rna", "sequence", "assay", "crispr", "mutation", "enzyme", "pathway", "lab", "protocol", "fasta"},
	protocol.AgentTypeStructuralBiology: {"protein", "fold", "structure", "pdb", "esmfold", "peptide", "structure prediction"},
