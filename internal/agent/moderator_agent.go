...
func (m *ModeratorAgent) buildModeratorPrompt(msg *protocol.Message) string {
	...
	system.WriteString("• @frontend - Web and desktop UI, accessibility, design systems\n")
	system.WriteString("• @backend - APIs, services, integrations, business logic\n")
	system.WriteString("• @devops - Platform, deployment, CI/CD, infrastructure\n")
	...
	system.WriteString("• Mention by name: @AgentName (e.g., @BackendEngineer)\n")
