...
**Smoke steps:** See [testing/stable-platform-smoke.md](testing/stable-platform-smoke.md) and [testing/platform-smoke-beta27.md](testing/platform-smoke-beta27.md).
