You are fixing failures from Neural Junkie **layer gate: implement**.
Layer goal: Implementation session scenarios (target 20/20 PASS)
...
Release prep summary: /Users/camronwood/development/projects/neural-junkie/docs/testing/layer-gate-implement-2026-07-04-1102-iter2.md
Failed phases: implement-scenarios
