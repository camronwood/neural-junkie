# release-prep fix loop — iteration 1 — 2026-06-29-0017-iter1 UTC
...
- [OK] python3 scripts/chat-scenarios.py --scenario dm-backend-deep-continuation (exit 0)
...
- [FAIL] python3 scripts/chat-scenarios.py --scenario dm-topic-switch (exit 1)
...
```text
agent SIGTERM (terminated — sleep, tmux kill, or parent stopped?) with no stdout captured
```
