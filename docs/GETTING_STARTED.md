...
1. Install from [GitHub Releases — v1.0.0-beta.32](https://github.com/camronwood/neural-junkie/releases/tag/v1.0.0-beta.32) or the [downloads page](https://camronwood.github.io/neural-junkie/download.html).
