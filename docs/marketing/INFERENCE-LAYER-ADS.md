...
| Asset | Variant | Angle |
|-------|---------|-------|
| `assets/neural-junkie-inference-skip-ad-1080.png` | `skip` | Closure intent → zero tokens |
| `assets/neural-junkie-inference-gate-ad-1080.png` | `gate` | Context stack → router → model pipeline |
| `assets/neural-junkie-inference-trust-ad-1080.png` | `trust` | Routing badge on every reply |
| `assets/neural-junkie-inference-layer-1200.png` | article | LinkedIn / website cover |

Related: [INFERENCE-LAYER-LINKEDIN.md](INFERENCE-LAYER-LINKEDIN.md) · [MODEL-LAYERING-LINKEDIN.md](MODEL-LAYERING-LINKEDIN.md) · [MODULAR-AI-COMPOSITION-LINKEDIN.md](MODULAR-AI-COMPOSITION-LINKEDIN.md)
...
**Image:** `assets/neural-junkie-inference-layer-1200.png`
...
Use [INFERENCE-LAYER-LINKEDIN.md](INFERENCE-LAYER-LINKEDIN.md) as the long-form LinkedIn article. Cover: `assets/neural-junkie-inference-layer-1200.png`.
