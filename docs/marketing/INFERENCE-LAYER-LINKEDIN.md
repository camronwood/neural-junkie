...
**Cover image:** `assets/neural-junkie-inference-layer-1200.png` (1200×627)
...
**Related articles:** [Model layering](MODEL-LAYERING-LINKEDIN.md) · [Modular AI composition](MODULAR-AI-COMPOSITION-LINKEDIN.md)
...
This builds on our earlier articles on [model layering](https://github.com/camronwood/neural-junkie/blob/main/docs/marketing/MODEL-LAYERING-LINKEDIN.md) and [modular composition](https://github.com/camronwood/neural-junkie/blob/main/docs/marketing/MODULAR-AI-COMPOSITION-LINKEDIN.md). Those explain *what stacks together*. This one explains *when and why tokens get spent* — and how you can verify it.
...
**Earlier in the series:** [Model layering](https://github.com/camronwood/neural-junkie/blob/main/docs/marketing/MODEL-LAYERING-LINKEDIN.md) · [Modular AI composition](https://github.com/camronwood/neural-junkie/blob/main/docs/marketing/MODULAR-AI-COMPOSITION-LINKEDIN.md)
