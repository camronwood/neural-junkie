...
| Asset | Variant | Angle |
|-------|---------|--------|
| `assets/neural-junkie-domain-packs-ad-1080.png` | `packs` | Dev pack vs Life sciences pack — one toggle |
| `assets/neural-junkie-session-memory-ad-1080.png` | `session-memory` | Turn intent + rolling session summary |
| `assets/neural-junkie-runbook-actions-ad-1080.png` | `runbook-actions` | HTTP/webhook steps in runbook DAG |
| `assets/neural-junkie-biology-pack-ad-1080.png` | `biology` | Sequence analysis + ESMFold |

Non-developer ads from beta.11 remain valid: [NONDEV-ADS.md](NONDEV-ADS.md), [SECOND-OPINION-AD.md](SECOND-OPINION-AD.md).
