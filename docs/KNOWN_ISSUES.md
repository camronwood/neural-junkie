...
**Last updated:** 2026-09-09 · **Current beta:** [v1.2.0-beta.28](https://github.com/camronwood/neural-junkie/releases/tag/v1.2.0-beta.28) ([latest](https://github.com/camronwood/neural-junkie/releases/latest)) · **Stable path:** [STABLE_RELEASE_CHECKLIST.md](STABLE_RELEASE_CHECKLIST.md)
...
| `collab-generation-error` | **Mitigated (Ollama); cloud deferred** | [#21](https://github.com/camronwood/neural-junkie/issues/21) | Cloud providers (Claude, Gemini) loop `generation_error` during collab planning — P0 turn handoff + CollaborationPanel gen-error banner. **2026-08-25:** Ollama core + `collab-generation-error-resilience` PASS. **2026-08-27–09-09 (P5–P8):** cloud repro skipped (`claude not authenticated`). Leave open until operator re-smokes with Claude/Gemini creds. |
