...
Neural Junkie is a working multi-agent workspace — local-first desktop app, Slack integration, domain packs, and bounded collaboration. **Latest tagged build:** [v1.2.0-beta.27](https://github.com/camronwood/neural-junkie/releases/tag/v1.2.0-beta.27) (P7: Slack/Assistant domains + command-palette extract). Gate 5 interactive smoke still open on [#18](https://github.com/camronwood/neural-junkie/issues/18) ([platform-smoke-beta26.md](testing/platform-smoke-beta26.md) package verify PASS). **Stable cut:** follow [STABLE_RELEASE_CHECKLIST.md](STABLE_RELEASE_CHECKLIST.md) and [STABLE_SCOPE.md](STABLE_SCOPE.md).
