...
**Beta:** [GitHub Releases — v1.0.0-beta.2](https://github.com/camronwood/neural-junkie/releases/tag/v1.0.0-beta.2) (v1.0.0-beta.1 installers incomplete — use beta.2) — pick the installer for your platform:
