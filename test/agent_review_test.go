...
func (m *mockHubClientReview) GetThreadMessages(string, int) ([]*protocol.Message, error) { return nil, nil }
...
func (m *mockHubClientReview) MusicGenerationEnabled() bool { return false }
