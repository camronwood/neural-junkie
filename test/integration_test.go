...
func (m *mockHubClientIntegration) GetThreadMessages(string, int) ([]*protocol.Message, error) { return nil, nil }
...
func (m *mockHubClientIntegration) MusicGenerationEnabled() bool { return false }
...
func (m *mockHubClientIntegration) ArenaEnabled() bool { return false }
func (m *mockHubClientIntegration) ArenaSidecarGet(context.Context, string) (map[string]any, error) { return nil, nil }
func (m *mockHubClientIntegration) ArenaSidecarPost(context.Context, string, map[string]any) (map[string]any, error) {
	return nil, nil
}
...
func (m *mockHubClientIntegration) RequestToolApproval(string, string, string, string, map[string]interface{}) (bool, error) {
	return true, nil
}
