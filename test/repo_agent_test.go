...
func (m *mockHubClientRepo) GetChannelSessionSummary(channel string) string         { return "" }
func (m *mockHubClientRepo) GetThreadMessages(string, int) ([]*protocol.Message, error) { return nil, nil }
func (m *mockHubClientRepo) IsChannelHeld(channel string) bool                     { return false }
func (m *mockHubClientRepo) ImageGenerationEnabled() bool                            { return false }
func (m *mockHubClientRepo) GenerateAndPostImage(context.Context, string, protocol.AgentInfo, string, string) error {
	return nil
}
func (m *mockHubClientRepo) MusicGenerationEnabled() bool { return false }
func (m *mockHubClientRepo) GenerateAndPostMusic(context.Context, string, protocol.AgentInfo, agent.MusicGenerateRequest) error {
	return nil
}
func (m *mockHubClientRepo) ExtractAndPostMusicStems(context.Context, string, protocol.AgentInfo, agent.MusicExtractRequest) error {
	return nil
}
func (m *mockHubClientRepo) ArenaEnabled() bool { return false }
func (m *mockHubClientRepo) ArenaSidecarGet(context.Context, string) (map[string]any, error) { return nil, nil }
func (m *mockHubClientRepo) ArenaSidecarPost(context.Context, string, map[string]any) (map[string]any, error) {
	return nil, nil
}

func (m *mockHubClientRepo) AskUserQuestion(string, string, string, string, []string) (string, error) {
	return "", nil
}
func (m *mockHubClientRepo) RequestToolApproval(string, string, string, string, map[string]interface{}) (bool, error) {
	return true, nil
}
